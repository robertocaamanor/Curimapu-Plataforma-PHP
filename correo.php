<?php   
  ...
  include 'mensajeventas.php';
	$conn = ConnectDB();  
	$fechahoy = date( "Y-m-d" );
 	$semana = date( "Y-m-d", strtotime("-7 days",strtotime($fechahoy)));  
	$result = listarCorreosVentas($conn, $semana, $fechahoy);
          ...
          <div class="list-group">
            <a class="list-group-item">
              <div class="grupo">
                  ...
                  <?php
                    if(($row['bandera']=='N') || ($row['bandera']=='F') || ($row['bandera']==NULL)) {
                      correoventa($row['id'], $row['nombreespecie'], $date);
                    }
                  ?>
