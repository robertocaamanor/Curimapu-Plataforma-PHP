...
<div class="sitio-principal">
  <div class="panelsemilllas">
    ...
    <div class="panel-cuerpo">
      <form id="venta" action="mensajevisita.php" method="POST" enctype="multipart/form-data">
      <div class="form-group">
        <label for="emailagricultor">E-mail del agricultor</label>
        <?php
          $consulta_mysql='select * from Agricultorr ORDER BY Agricultorr_nombre ASC';
          ...
          while($fila=mssql_fetch_array($resultado_consulta_mysql)){
              echo "<option value='".$fila['Agricultorr_email']."'>".$fila['Agricultorr_nombre']." - ".$fila['Agricultorr_email']."</option>";
          }
          echo "</select>";
        ?>
